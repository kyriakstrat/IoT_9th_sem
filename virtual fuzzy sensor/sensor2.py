...
# Test all hours of the day for a specific season
input_season = 3  # Spring for example

# Initialize output variables
output_window_closed_all_hours = np.zeros_like(time_of_day)

# Fuzzy rules
# ... (previous rules)

# Test all hours of the day for the given season
...
# Visualization of the result for window_closed
plt.figure(figsize=(10, 6))
plt.plot(time_of_day, output_window_closed_all_hours, label='Window Closed')
plt.title('Fuzzy System Output (Window Closed) for Spring')
